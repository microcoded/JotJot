...
class RecyclerAdapter(private val context: Context, private val listRecyclerItem: List<Any>, private val cellClickListener: MainActivity) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        // Setting values for all the TextViews
        val title: TextView = itemView.findViewById<View>(R.id.title) as TextView
        val content: TextView = itemView.findViewById<View>(R.id.content) as TextView
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, i: Int) {
        when (getItemViewType(i)) {
            TYPE -> {
                ...
                itemViewHolder.content.text = jotlist.content
