...
class NotesRecyclerAdapter(private val context: Context, private val listRecyclerItem: List<Any>, private val cellClickListener: Notes) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
