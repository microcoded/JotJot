...
class ListRecyclerAdapter(private val context: Context, private val listRecyclerItem: List<Any>, private val cellClickListener: Lists) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
